...
Version  : 2.3.0
Release  : 2
URL      : https://github.com/seccomp/libseccomp/archive/v2.3.0.tar.gz
Source0  : https://github.com/seccomp/libseccomp/archive/v2.3.0.tar.gz
