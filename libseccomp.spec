...
Source0  : https://github.com/seccomp/libseccomp/releases/download/v2.5.0/libseccomp-2.5.0.tar.gz
Source1  : https://github.com/seccomp/libseccomp/releases/download/v2.5.0/libseccomp-2.5.0.tar.gz.asc
...
%prep
%setup -q -n libseccomp-2.5.0
cd %{_builddir}/libseccomp-2.5.0
pushd ..
cp -a libseccomp-2.5.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595291181
...
cp %{_builddir}/libseccomp-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/libseccomp/4c04c844a5cb16b3629d0052f1304b7a565bd4a8
pushd ../build32/
%make_install32
