...
Source0  : https://github.com/seccomp/libseccomp/releases/download/v2.5.5/libseccomp-2.5.5.tar.gz
Source1  : https://github.com/seccomp/libseccomp/releases/download/v2.5.5/libseccomp-2.5.5.tar.gz.asc
...
cd %{_builddir}/libseccomp-2.5.5
pushd ..
cp -a libseccomp-2.5.5 build32
popd
pushd ..
cp -a libseccomp-2.5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702023113
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libseccomp.so.2.5.5
/usr/lib64/libseccomp.so.2
/usr/lib64/libseccomp.so.2.5.5
