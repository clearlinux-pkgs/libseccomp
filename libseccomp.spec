...
Version  : 2.2.3
Release  : 1
URL      : https://github.com/seccomp/libseccomp/archive/v2.2.3.tar.gz
Source0  : https://github.com/seccomp/libseccomp/archive/v2.2.3.tar.gz
